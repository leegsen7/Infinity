define(function(require){
	...
	Slider.prototype = {
		...
		ondrag: function (pos,x) {
			this.step.style.width = Math.max(0, parseInt(x+this.btn.offsetWidth/2)) + 'px';
			return pos;
		},
		setSlider:function(num){
			...
			this.step.style.width = (this.bar.offsetWidth - this.btn.offsetWidth)*num/100 + this.btn.offsetWidth/2 + 'px';
		},
	}	
	return Slider;
})
